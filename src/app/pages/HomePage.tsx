...
<div className="mt-6 sm:mt-8 w-full max-w-[90%] sm:max-w-md md:max-w-xl px-2 sm:px-0">
  <div className="flex bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl">
    ...
    >
        ...
        {t("search", language).split("...")[0]}
          ...
          <div className="mt-6 flex gap-3 flex-wrap justify-center">
            <button
              ...
              className="bg-primary text-white px-7 py-3.5 rounded-xl font-bold text-base hover:bg-[#163d2e] transition-colors flex items-center gap-2 shadow-lg"
            >
            ...
            <button
              onClick={() => navigate("/products")}
              className="bg-accent text-white px-7 py-3.5 rounded-xl font-bold text-base hover:bg-[#b8872c] transition-colors flex items-center gap-2 shadow-lg"
            >
      ...
      {/* Stats */}
      <section className="bg-gradient-to-br from-[#1E4D3B]/5 to-[#D2A63B]/10 py-12">
