...
export function SupplierProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Header */}
      <div className="bg-gradient-to-br from-[#1E4D3B]/5 to-[#D2A63B]/10">
        <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="relative">
              ...
              />
              {supplier.verified && (
                <div className="absolute -bottom-2 -right-2 bg-[#1E4D3B] rounded-full p-2 shadow-lg">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <div>
                  ...
                  <div className="flex items-center gap-3 flex-wrap mb-3">
                    ...
                    <div className="flex items-center gap-1">
                      <Star className="w-4 h-4 fill-[#D2A63B] text-[#D2A63B]" />
                ...
                {/* Contact button */}
                <button className="bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold hover:bg-[#163d2e] transition-colors flex items-center gap-2">
