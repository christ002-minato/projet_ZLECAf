...
import {
  Globe2, Menu, X, LogIn, UserPlus, MapPin, ChevronDown,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-border shadow-sm">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          ...
          >
            ...
            <span
              className="font-black text-foreground text-lg leading-none hidden sm:block"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="bg-primary text-primary-foreground px-4 py-2 rounded-lg text-sm font-bold hover:bg-green-700 transition-colors hidden md:flex items-center gap-1.5"
            >
          ...
          <div className="md:hidden bg-white border-t border-border px-4 py-4 flex flex-col gap-3">
            ...
            <div className="border-t border-border pt-3 flex flex-col gap-2">
              ...
              <button
                ...
                className="w-full py-3 bg-primary text-white rounded-xl text-sm font-bold hover:bg-green-700 transition-colors"
              >
                {t("register", language)}
              </button>
            </div>
      ...
      <footer className="bg-foreground text-white px-4 py-10 pb-24 md:pb-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr] gap-8">
          <div>
            <Link to="/" className="inline-flex items-center gap-2" aria-label="AfriMarket Connect">
              <div className="w-9 h-9 bg-primary rounded-lg flex items-center justify-center">
                <Globe2 className="w-5 h-5 text-white" />
              </div>
